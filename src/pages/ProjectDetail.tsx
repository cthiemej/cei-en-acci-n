          ...
          <Card className="shadow-sm">
            <CardContent className="pt-6 space-y-4">
              <div className="grid sm:grid-cols-2 gap-4 text-sm">
                ...
                <div><span className="text-muted-foreground">Facultad o Centro:</span> <span className="font-medium">{project.faculty_or_center ?? '-'}</span></div>
                <div><span className="text-muted-foreground">Otros investigadores:</span> <span className="font-medium">{project.co_investigators ?? '-'}</span></div>
                <div><span className="text-muted-foreground">Fecha de aprobación:</span> <span className="font-medium">{project.approval_date ? new Date(project.approval_date).toLocaleDateString('es-CL') : '-'}</span></div>
                <div><span className="text-muted-foreground">Duración:</span> <span className="font-medium">{project.duration_months ? `${project.duration_months} meses` : '-'}</span></div>
